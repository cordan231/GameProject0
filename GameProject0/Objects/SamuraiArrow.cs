...
namespace GameProject0.Objects
{
    public class SamuraiArrow
    {
        ...
        public SamuraiArrow(Vector2 position, Direction direction)
        {
            Position = position;
            Direction = direction;
        ...
        {
            _texture = content.Load<Texture2D>("samurai_Arrow");
            UpdateBounds();
        }
        ...
        private void UpdateBounds()
        {
            ...
            Bounds = new BoundingRectangle(Position.X, Position.Y + height / 2 - 10, width, 20);
        }
        ...
        public void Update(GameTime gameTime, Viewport viewport)
        {
            ...
            if (Position.X > viewport.Width + 100 || Position.X < -100) IsRemoved = true;
        }
